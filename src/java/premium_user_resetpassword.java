...
public class premium_user_resetpassword extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement(
                "UPDATE premiumuser SET password = ? WHERE email = ?"
            );
            ...
            if (rowsUpdated > 0) {
                out.println("<script>alert('Password updated successfully.'); window.location='premium_user_login.html';</script>");
            } else {

...
public class premium_VerifyOtpServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (savedOtp != null && savedOtp.equals(inputOtp)) {
            ...
            out.println("window.location.href = 'premium_user_register.html?email=" + email + "';");
            out.println("</script>");
            out.println("</body>");
            out.println("</html>");
        } else {
            ...
            out.println("window.location.href = 'premium_verify_otp.html';");
            out.println("</script>");
            out.println("</body>");
            out.println("</html>");
        }

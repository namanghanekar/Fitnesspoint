...
@WebServlet("/Premium_PhotoServlet") // Mapping servlet URL
public class Premium_PhotoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ps = cn.prepareStatement("SELECT photo FROM premiumuser WHERE email = ?");
            ps.setString(1, mail);
            rs = ps.executeQuery();

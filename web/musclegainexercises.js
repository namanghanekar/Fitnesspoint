...
document.addEventListener('DOMContentLoaded', function() {
        ...
        cardio: [
            {
                ...
                videoId: "c4DAnQ6DtF8",
                image: "./images/jumping-jacks-exercise-illustration-300x200.jpg?height=60&width=60&text=Jumping+Jacks"
            },
            {
                name: "High Knees",
                description: "Run in place, bringing knees up to hip level. Pump arms and maintain an upright posture.",
                videoId: "oDdkytliOqE",
                image: "images/high-knees-exercise-illustration-300x200.jpg?height=60&width=60&text=High+Knees"
            },
            {
                name: "Mountain Climbers",
                description: "Start in plank position. Alternate bringing knees toward chest in a running motion.",
                videoId: "nmwgirgXLYM",
                image: "images/mountain-climbers-exercise-illustration-300x200 (1).jpg?height=100&width=60&text=Mountain+Climbers"
            },
            {
                name: "Burpees",
                ...
                videoId: "TU8QYVW0gDU",
                image: "images/burpees-exercise-illustration-300x200.jpg?height=60&width=60&text=Burpees"
            },
            {
                name: "Jump Rope",
                description: "Swing rope over head and under feet, jumping slightly to let rope pass. Keep elbows close to body.",
                videoId: "u3zgHI8QnqE",
                image: "images/jump-rope-exercise-illustration-300x200.jpg?height=60&width=60&text=Jump+Rope"
            },
            {
                name: "Squat Jumps",
                description: "Lower into squat position, then explosively jump upward. Land softly and immediately lower into next squat.",
                videoId: "CVaEhXotL7M",
                image: "images/squat-jacks-exercise-illustration-300x200.jpg?height=60&width=60&text=Squat+Jumps"
            },
            {
                name: "Jumping Lunges",
                description: "Start in lunge position. Jump up and switch legs in mid-air, landing in lunge with opposite leg forward.",
                videoId: "hTdcOG9muQk",
                image: "images/jumping-lunges-exercise-illustration-300x200.jpg?height=60&width=60&text=Jumping+Lunges"
            },
            {
                name: "Speed Skaters",
                ...
                videoId: "qXpy7Xpf_Cg",
                image: "images/speed-skate-exercise-illustration-300x200.jpg?height=60&width=60&text=Speed+Skaters"
            }
        ],
        ...
        strength: [
            {
                ...
                videoId: "IODxDxX7oi4",
                image: "images/push-up-exercise-illustration-300x200.jpg?height=60&width=60&text=Push-ups"
            },
            {
                name: "Squats",
                description: "Stand with feet shoulder-width apart. Lower hips back and down as if sitting in chair, then return to standing.",
                videoId: "aclHkVaku9U",
                image: "images/squat-exercise-illustration-300x200.jpg?height=60&width=60&text=Squats"
            },
            {
                name: "Lunges",
                ...
                videoId: "QOVaHwm-Q6U",
                image: "images/lunges-exercise-illustration-300x200.jpg?height=60&width=60&text=Lunges"
            },
            {
                name: "Plank",
                description: "Hold push-up position with body in straight line from head to heels. Keep core engaged and don't let hips sag.",
                videoId: "pSHjTRCQxIw",
                image: "images/plank-exercise-illustration-300x200.jpg?height=60&width=60&text=Plank"
            },
            {
                name: "Dumbbell Rows",
                description: "Bend at hips with flat back, holding weight in one hand. Pull weight up to side of body, keeping elbow close.",
                videoId: "roCP6wCXPqo",
                image: "images/dumbbell-row-exercise-illustration-spotebi-300x200.jpg?height=60&width=60&text=Dumbbell+Rows"
            },
            {
                name: "Glute Bridges",
                description: "Lie on back with knees bent. Push through heels to lift hips toward ceiling, squeezing glutes at top.",
                videoId: "wPM8icPu6H8",
                image: "images/glute-bridge-exercise-illustration-300x200.jpg?height=60&width=60&text=Glute+Bridges"
            },
            {
                name: "Tricep Dips",
                ...
                videoId: "jox1rb5krQI",
                image: "images/tricep-dips-exercise-illustration-300x200.jpg?height=60&width=60&text=Tricep+Dips"
            },
            {
                ...
                videoId: "Iwyvozckjak",
                image: "images/bicycle-crunches-exercise-illustration-300x200.jpg?height=60&width=60&text=Bicycle+Crunches"
            }
        ],
        ...
        core: [
            {
                ...
                videoId: "4hmQD9Ov3ms",
                image: "images/crunches-exercise-illustration-300x200.jpg?height=60&width=60&text=Crunches"
            },
            {
                name: "Russian Twists",
                description: "Sit with knees bent and lean back slightly. Rotate torso side to side, touching floor beside hips.",
                videoId: "wkD8rjkodUI",
                image: "images/russian-twist-exercise-illustration-300x200.jpg?height=60&width=60&text=Russian+Twists"
            },
            {
                name: "Leg Raises",
                description: "Lie on back with legs straight. Lift legs toward ceiling while keeping lower back pressed into floor.",
                videoId: "JB2oyawG9KI",
                image: "images/leg-rise.jpg?height=60&width=60&text=Leg+Raises"
            },
            {
                name: "Plank Shoulder Taps",
                description: "Start in plank position. Tap opposite shoulder with hand while maintaining stable hips and core.",
                videoId: "gWHQpMUd7vw",
                image: "images/plank-shoulder-tap-exercise-illustration-spotebi-300x200.jpg?height=60&width=60&text=Plank+Shoulder+Taps"
            },
            {
                name: "Side Planks",
                description: "Lie on side with elbow under shoulder. Lift hips to create straight line from head to feet.",
                videoId: "rCxF2nG0MnI",
                image: "images/side-plank-exercise-illustration-300x200.jpg?height=60&width=60&text=Side+Planks"
            },
            {
                name: "Mountain Climbers",
                description: "Start in plank position. Alternate bringing knees toward chest in a running motion.",
                videoId: "nmwgirgXLYM",
                image: "images/mountain-climbers-exercise-illustration-300x200 (2).jpg?height=60&width=60&text=Mountain+Climbers"
            },
            {
                name: "Flutter Kicks",
                ...
                videoId: "ANVdMDaYRts",
                image: "images/flutter-kick-squat-exercise-illustration-300x200.jpg?height=60&width=60&text=Flutter+Kicks"
            },
            {
                name: "Hollow Hold",
                description: "Lie on back, arms extended overhead. Lift shoulders and legs off floor, creating a curved shape with body.",
                videoId: "63Q9ezNX5Pw",
                image: "images/hollow-hold.jpg?height=60&width=60&text=Hollow+Hold"
            }
        ],
        ...
        flexibility: [
            {
                ...
                videoId: "g7Uhp5tphAs",
                image: "images/forward-fold-back-exercise-illustration-spotebi-300x200.jpg?height=60&width=60&text=Forward+Fold"
            },
            {
                name: "Downward Dog",
                description: "Start on hands and knees. Lift hips up and back, straightening legs to form an inverted V shape.",
                videoId: "EC7RGJ975iM",
                image: "images/downward-dog-crunch-exercise-illustration-spotebi-300x200.jpg?height=60&width=60&text=Downward+Dog"
            },
            {
                name: "Cat-Cow Stretch",
                description: "Start on hands and knees. Alternate between arching back (cow) and rounding spine (cat).",
                videoId: "kqnua4rHVVA",
                image: "images/cat-pose-marjaryasana-300x200.jpg?height=60&width=60&text=Cat-Cow"
            },
            {
                name: "Butterfly Stretch",
                description: "Sit with soles of feet together. Hold feet and gently press knees toward floor.",
                videoId: "MkUVKVxrn4c",
                image: "images/butterfly-stretch-exercise-illustration-300x200.jpg?height=60&width=60&text=Butterfly+Stretch"
            },
            {
                name: "Hip Flexor Stretch",
                description: "Kneel on one knee with other foot in front. Push hips forward until you feel stretch in front hip.",
                videoId: "YQmpO9VT2X4",
                image: "images/hip-flexor-stretch-exercise-illustration-300x200.jpg?height=60&width=60&text=Hip+Flexor"
            },
            {
                name: "Shoulder Stretch",
                description: "Bring one arm across chest and use opposite hand to gently pull elbow closer to body.",
                videoId: "bP4p5LQGIqI",
                image: "images/shoulder-stretch-exercise-illustration-300x200.jpg?height=60&width=60&text=Shoulder+Stretch"
            },
            {
                name: "Child's Pose",
                description: "Kneel with toes together, knees apart. Sit back on heels and extend arms forward, lowering chest toward floor.",
                videoId: "eqVMAPM00DM",
                image: "images/childs-pose-balasana-300x200.jpg?height=60&width=60&text=Child's+Pose"
            },
            {
                name: "Cobra Stretch",
                description: "Lie face down with hands under shoulders. Press into hands to lift chest off floor while keeping hips down.",
                videoId: "JDcdhTuycOI",
                image: "images/cobra-pose-bhujangasana-300x200.jpg?height=60&width=60&text=Cobra+Stretch"
            }
        ],
    ...
    const dayTypes = [
        ...
        { 
            ...
            image: "images/stretch.jpg?height=160&width=350&text=Strength+Training"
        },
        { 
            type: 'core', 
            name: 'Core Focus',
            image: "images/core-balance.webp?height=160&width=350&text=Core+Focus"
        },
        { 
            type: 'cardio', 
            name: 'Cardio Endurance',
            image: "images/cardio-indurance.jpg?height=160&width=350&text=Cardio+Endurance"
        },
        { 
            type: 'strength', 
            name: 'Upper Body Strength',
            image: "images/upper-body.webp?height=160&width=350&text=Upper+Body"
        },
        { 
            type: 'flexibility', 
            name: 'Flexibility & Mobility',
            image: "images/flexiblity-mobility.jpg?height=160&width=350&text=Flexibility"
        },
        { 
            type: 'recovery', 
            name: 'Active Recovery',
            image: "images/rest-recovery.webp?height=160&width=350&text=Recovery"
        },
        { 
            type: 'cardio', 
            name: 'HIIT Training',
            image: "images/HIIT.avif?height=160&width=350&text=HIIT+Training"
        },
        { 
            type: 'strength', 
            name: 'Lower Body Strength',
            image: "images/Lower-Body-Workouts.960.jpg?height=160&width=350&text=Lower+Body"
        },
        { 
            type: 'core', 
            name: 'Core Stability',
            image: "images/core-balance.webp?height=160&width=350&text=Core+Stability"
        },
        { 
            type: 'cardio', 
            name: 'Cardio & Agility',
            image: "images/cardio-agility.jpg?height=160&width=350&text=Cardio+Agility"
        },
        { 
            type: 'strength', 
            name: 'Full Body Strength',
            image: "images/full-body-strength.jpg?height=160&width=350&text=Full+Body"
        },
        { 
            type: 'flexibility', 
            name: 'Deep Stretching',
            image: "images/deep-streght.jpg?height=160&width=350&text=Deep+Stretching"
        },
        { 
            type: 'recovery', 
            name: 'Rest & Recover',
            image: "images/rest-recovery.webp?height=160&width=350&text=Rest+Recover"
        },
        { 
            type: 'cardio', 
            name: 'Interval Training',
            image: "images/internal-traingning.jpg?height=160&width=350&text=Interval+Training"
        },
        { 
            type: 'strength', 
            name: 'Push & Pull Focus',
            image: "images/push-pull.jpg?height=160&width=350&text=Push+Pull"
        },
        { 
            type: 'core', 
            name: 'Core Power',
        ...
        { 
            ...
            image: "images/strength-endurance.webp?height=160&width=350&text=Functional"
        },
        { 
            type: 'flexibility', 
            name: 'Mobility Work',
            image: "images/flexiblity-mobility.jpg?height=160&width=350&text=Mobility"
        },
        { 
            type: 'recovery', 
            name: 'Active Recovery',
        ...
        { 
            ...
            image: "images/strength-endurance.webp?height=160&width=350&text=Compound"
        },
        { 
            type: 'core', 
            name: 'Core & Balance',
            image: "images/core-power.jpg?height=160&width=350&text=Core+Balance"
        },
        { 
            type: 'cardio', 
            name: 'Cardio Finisher',
            image: "images/cardio-finisher.jpg?height=160&width=350&text=Cardio+Finisher"
        },
        { 
            type: 'strength', 
            name: 'Strength Endurance',
            image: "images/endurance-traning.jpg?height=160&width=350&text=Strength+Endurance"
        },
        { 
            type: 'flexibility', 
            name: 'Full Body Flexibility',
            image: "images/full body.avif?height=160&width=350&text=Full+Flexibility"
        },
        { 
            type: 'recovery', 
            name: 'Gentle Movement',
            image: "images/gentel-movement.jpg?height=160&width=350&text=Gentle+Movement"
        },
        { 
            type: 'cardio', 
            name: 'Final Push',
            image: "images/final push.jpg?height=160&width=350&text=Final+Push"
        },
        { 
            type: 'strength', 
            name: 'Challenge Finale',
            image: "images/challange-finale.webp?height=160&width=350&text=Challenge+Finale"
        }
    ];
    ...
    function generateDayCards() {
        ...
        for (let i = 0; i < 30; i++) {
            ...
            const exercises = getRandomExercises(exerciseDatabase[dayType.type], 7);
